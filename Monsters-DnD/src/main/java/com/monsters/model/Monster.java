...
public class Monster implements Serializable{
	...
	public Monster(String name, String intro, String armor_class, String hit_points, String speed, int strength,
			...
			int charisma, String charisma_modifier, String saving_throws, String skills, String senses,
			String languages, String challenge, String exp, String traits, String actions, String legendery_actions,
			String img_url) {
		super();
