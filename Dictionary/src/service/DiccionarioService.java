...
public class DiccionarioService {
	...
	public void Buscador(String word, boolean exact) throws IOException {
		...
		Map<Character, Integer> OurWordMap = MapearPalabra(word);
		boolean result = false;

		try (BufferedReader reader = new BufferedReader(
				new FileReader("C:/Users/Usuario/Documents/My Web Sites/Java/diccionario/dictionary.txt"))) {
			...
			for (String dictWord = reader.readLine(); dictWord != null; dictWord = reader.readLine()) {
				Map<Character, Integer> dictWordMap = MapearPalabra(dictWord);
				boolean Doable = true;
