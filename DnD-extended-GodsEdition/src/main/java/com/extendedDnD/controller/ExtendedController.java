...
import com.extendedDnD.service.GodsService;
...
public class ExtendedController {
	...
	public String newUser(@ApiParam("user data") @RequestBody User user){
	...
	@ApiOperation("Get list of all gods")
	@GetMapping(value="/gods")
	public List<God> getGodsList() {
		return gapp.getGods();
	}
	
	@ApiOperation("get content of appendix")
	@GetMapping(value="/gods/appendixContent")
	public String getAppendixContent() {
		return gapp.getAppendixContent();
	}
	
	@ApiOperation("get gods alignments")
	@GetMapping(value="/gods/Alignments")
	public List<String> getGodsAlignments() {
		return gapp.getAlignments();
	}
	
	@ApiOperation("get content of pantheon")
	@GetMapping(value="/gods/pantheonContent")
	public String[] getPantheonContent() {
		return gapp.getPantheonContent();
	}
	
	@ApiOperation("get gods by origin")
	@GetMapping(value="/gods/byOrigin")
	public List<God> getGodsByOrigin(@ApiParam("origin to search") @RequestParam("origin") String origin) {
		return gapp.getGodsByOrigin(origin);
	}
	
	@ApiOperation("get gods by alignment")
	@GetMapping(value="/gods/byAlignment")
	public List<God> getGodsByAlignment(@ApiParam("alignment to search") @RequestParam("alignment") String alignment) {
		return gapp.getGodsByAlignment(alignment);
	}
	
	@ApiOperation("sort gods by deity name")
	@GetMapping(value="/gods/sortGodsDeity")
	public List<God> sortGodsByDeity(@ApiParam("ascendent? y/n") @RequestParam("asc") boolean asc) {
		return gapp.sortGodsByDeity(asc);
	}
	
	@ApiOperation("sort gods by deity origin")
	@GetMapping(value="/gods/sortGodsOrigin")
	public List<God> sortGodsByOrigin(@ApiParam("ascendent? y/n") @RequestParam("asc") boolean asc) {
		return gapp.sortGodsByOrigin(asc);
	}
	
	@ApiOperation("sort gods by deity alignment")
	@GetMapping(value="/gods/sortGodsAlignment")
	public List<God> sortGodsByAlignment(@ApiParam("ascendent? y/n") @RequestParam("asc") boolean asc) {
		return gapp.sortGodsByAlignment(asc);
	}
	
	@ApiOperation("sort gods by deity domains")
	@GetMapping(value="/gods/sortGodsDomain")
	public List<God> sortGodsByDomains(@ApiParam("ascendent? y/n") @RequestParam("asc") boolean asc) {
		return gapp.sortGodsByDomains(asc);
	}
	
	@ApiOperation("sort gods by deity symbol")
	@GetMapping(value="/gods/sortGodsSymbol")
	public List<God> sortGodsBySymbol(@ApiParam("ascendent? y/n") @RequestParam("asc") boolean asc) {
		return gapp.sortGodsBySymbol(asc);
	}
}
