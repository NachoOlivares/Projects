...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				...
				.antMatchers("/ListarCursos").authenticated()
				.antMatchers("/EliminarCursos/{denominacion}").hasRole("ADMIN")
				.antMatchers("/buscarTematica/{tematica}").authenticated()
				.antMatchers("/modificarCursos").hasRole("ADMIN")
